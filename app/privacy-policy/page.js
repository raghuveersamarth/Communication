      ...
      <div className="w-full max-w-lg bg-white dark:bg-[#151515] rounded-2xl shadow-xl py-10 px-6 sm:px-10 mx-auto">
        ...
        <RevealOnScroll delay={0.1}>
          <ul className="mb-5 text-base sm:text-lg text-gray-700 dark:text-gray-300 list-disc pl-6 space-y-3">
            <li>We collect only essential details: your Gmail and phone number.</li>
            <li>We do <span className="font-bold">not</span> use cookies or track your browsing activity.</li>
            <li>Your personal details are used solely for providing course access and communication.</li>
            <li>We never sell, rent, or share your data with third parties.</li>
            <li>You may contact us to update or delete your information.</li>
          </ul>
        </RevealOnScroll>
