      ...
      <div className="w-full max-w-lg bg-white dark:bg-[#151515] rounded-2xl shadow-xl py-10 px-6 sm:px-10 mx-auto">
        ...
        <RevealOnScroll delay={0.1}>
          <ul className="mb-5 text-base sm:text-lg text-gray-700 dark:text-gray-300 list-disc pl-6 space-y-3">
            <li>Access to the course is provided only after successful payment.</li>
            <li>Payment is a <span className="font-bold">one-time fee</span> and is <span className="font-bold">non-refundable</span>.</li>
            <li>Course access is personal and cannot be shared, transferred, or resold.</li>
            <li>Unauthorized distribution or misuse of content may result in termination of access.</li>
            <li>We are not liable for misuse of the content or issues outside our control.</li>
          </ul>
        </RevealOnScroll>
